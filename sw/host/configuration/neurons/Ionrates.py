...
class Ionrates:
    ...
    def getIonRates(self, nrn_model:str, dt, gen_fpga_sim_files=False, fp_width=SFI.ION.WIDTH, fp_dec=SFI.ION.DEC):
        ...
        if   nrn_model == "pospischil":
            ...
            for v in v_ramp:
                # Na
                mNa_r1.append( r1_hines(alpha_m_Na(v), beta_m_Na(v), dt))
                mNa_r2.append( r2_hines(alpha_m_Na(v), beta_m_Na(v), dt))
                hNa_r1.append( r1_hines(alpha_h_Na(v), beta_h_Na(v), dt))
                hNa_r2.append( r2_hines(alpha_h_Na(v), beta_h_Na(v), dt))
                # K
                mK_r1.append( r1_hines(alpha_m_K(v), beta_m_K(v), dt) )
                mK_r2.append( r2_hines(alpha_m_K(v), beta_m_K(v), dt) )
                # M
                mM_r1.append( 0.0 )
                mM_r2.append( 0.0 )
                # L
            ...
            h_rates1.append(ones)   ; h_rates2.append(ones)     # K
            h_rates1.append(ones)   ; h_rates2.append(ones)     # M
            h_rates1.append(ones)  ; h_rates2.append(ones)    # L
            h_rates1.append(ones)  ; h_rates2.append(ones)    # T
