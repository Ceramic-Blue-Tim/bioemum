...
def gen_config_bioemum(config_name:str, save_path:str):
    ...
    # local_dirpath_save  = "C:/PhD/Projects/SNN-HH/fpga/zynqmp/target/kria/config"
    ...
    swconfig_builder.parameters["fpath_hwconfig"]              = "/home/ubuntu/bioemum/config/hwconfig_" + config_fname + ".txt"
    swconfig_builder.parameters["emulation_time_s"]            = 0.05
    swconfig_builder.parameters["sel_nrn_vmem_dac"]            = [0, 1, 2, 3, 4, 5, 6, 7]
    swconfig_builder.parameters["sel_nrn_vmem_dma"]            = [x for x in range(64)]
    swconfig_builder.parameters["save_local_spikes"]           = False
    swconfig_builder.parameters["save_local_vmem"]             = True
    swconfig_builder.parameters["save_path"]                   = "/home/ubuntu/bioemum/data/" # target saving director
    ...
    swconfig_builder.parameters["stim_duration_ms"]            = 15
